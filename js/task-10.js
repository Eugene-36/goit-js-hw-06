...
const getSortedUniqueSkills = function(users) {
 return   users.reduce((acc, element)=>{
        ...
        return acc
    },[]).filter((skills, idx, users)=> users.indexOf(skills)===idx).sort()
}
// Вариант Ларисы
...
// при этом не должно быть повторяющихся умений и о
// ни должны быть отсортированы в алфавитном порядке.